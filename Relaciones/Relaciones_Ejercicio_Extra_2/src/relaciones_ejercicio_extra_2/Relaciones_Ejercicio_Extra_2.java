 ...
 */
package relaciones_ejercicio_extra_2;

import java.util.ArrayList;
import relaciones_ejercicio_extra_2_Entidades.Cine;
import relaciones_ejercicio_extra_2_Entidades.Espectador;
import relaciones_ejercicio_extra_2_Servicio.ServicioCine;

/**
 *
 * @author Anny
 */
public class Relaciones_Ejercicio_Extra_2 {

    /**
     * @param args the command line arguments
     */
    public static void main(String[] args) {
        ServicioCine  s = new ServicioCine();
        s.simulacionCine();
        s.mostrarSala();
