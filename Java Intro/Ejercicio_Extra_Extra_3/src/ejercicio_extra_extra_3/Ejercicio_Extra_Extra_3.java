...
SINO impedir cambios
 */
package ejercicio_extra_extra_3;

import ejercicio_extra_extra_3_Entidad.Pass;

/**
 *
 * @author Anny
 */
public class Ejercicio_Extra_Extra_3 {
    ...
    public static void main(String[] args) {
      ...
      Pass pass= new Pass ("eurekaseurekas", "anna", 123456);
